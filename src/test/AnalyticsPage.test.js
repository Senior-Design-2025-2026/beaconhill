  ...
  return function useFarmWeather() {
    ...
    return {
      ...
      ambientTrend: {
        ...
        nitrogenDioxide: hourly.map((p) => ({ ...p, y: 8.5 })),
        airQuality: hourly.map((p) => ({ ...p, y: 34 })),
      },
      forecast: {
        days: [
          { date: '2026-03-23', avgTempF: 66, avgHumidity: 60, totalPrecipIn: 0.0, nitrogenDioxide: 8, airQuality: 40 },
          { date: '2026-03-24', avgTempF: 62, avgHumidity: 65, totalPrecipIn: 0.2, nitrogenDioxide: 6, airQuality: 35 },
        ],
      },
      loading: false,
      error: null,
